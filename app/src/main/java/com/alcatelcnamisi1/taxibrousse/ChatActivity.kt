...
class ChatActivity : AppCompatActivity() {
    ...
    private fun fillData() {
        ...
        val room = RainbowSdk.instance().bubbles().findBubblesByName(communityName)[0]
                ...
                scrollView.post {
                    ...
                    RainbowSdk.instance()
                            ...
                            .markMessageFromConversationAsRead(
                                    m_conversation,
                                    messages.items[messages.count - 1]
                            )
                }
            }
        }
                ...
                object : TextWatcher {
                    ...
                    override fun onTextChanged(
                        ...
                        if (!isTyping) {
                            ...
                            RainbowSdk.instance()
                                    .im()
                                    .sendIsTyping(m_conversation, ChatState.composing)
                        }
                        ...
                        typingHandler.postDelayed(
                                {
                                    ...
                                    RainbowSdk.instance()
                                            .im()
                                            .sendIsTyping(m_conversation, ChatState.inactive)
                                },
                                2000
                        )
                    }
